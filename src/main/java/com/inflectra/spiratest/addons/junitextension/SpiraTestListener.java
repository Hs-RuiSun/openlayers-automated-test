...
{
	public static final String TEST_RUNNER_NAME = "JUnit";

	public static Vector<TestRun> testRunVector;
	private String url;
	...
	public void testFailure(Failure failure)
	{
		...
		{
			TestRun testRun = (TestRun)  testRunVector.elementAt(i);
	...
	public void testRunStarted (Description description)
	{
		//Create a new vector of test runs
		 testRunVector = new Vector<TestRun>();
	...
	public void testRunFinished (Result result)
	{
		...
		try
		{
			...
			for (int i = 0; i <  testRunVector.size(); i++)
			{
				...
				spiraTestExecute.spiraProjectId = testRun.projectId; 
