...
public class NgWebDriverTest {
    ...
    public void find_by_angular_model() {
        ...
        assertEquals(driver.findElement(By.xpath("//input")).getAttribute("value"), "Mary");
    ...
    public void find_multiple_hits_for_ng_repeat_in_page() {
        ...
        List<WebElement> wes = driver.findElement(By.tagName("table")).findElements(ByAngular.repeater("person in people"));

        assertThat(wes.size(), is(4));
        assertThat(wes.get(0).findElement(By.tagName("td")).getText(), containsString("John"));
        assertThat(wes.get(1).findElement(By.tagName("td")).getText(), containsString("Bob"));
        assertThat(wes.get(2).findElement(By.tagName("td")).getText(), containsString("Jack"));
        assertThat(wes.get(3).findElement(By.tagName("td")).getText(), containsString("Michael"));
    ...
    public void find_specific_cell_in_ng_repeat() {
        ...
        assertThat(driver.findElement(By.xpath("//tr[@byNg-repeat='person in selectablePeople']")).getText(), is("x y z"));
    }
    ...
    public void model_mutation_and_query_is_possible() {
        ...
        WebElement fn = driver.findElement(By.id("firstNameEdit1"));
        fn.sendKeys("Fred");
        WebElement ln = driver.findElement(By.id("lastNameEdit1"));
...
//        assertThat(id, is(1675L));
    ...
    public void altRoot_find_elements() {
        ...
        fwd.div(By.id("outside-ng")).getText().shouldBe("{{1 + 2}}");
        fwd.div(By.id("inside-ng")).getText().shouldBe("3");
    }
    ...
    public void basic_elements_chained_call_should_wait_to_grab_the_WebElement_until_a_method_is_called() {
        ...
        FluentWebElement reused = fwd.div(By.id("baz")).span(ByAngular.binding("item.reusedBinding"));
